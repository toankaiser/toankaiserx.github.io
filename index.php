...
<body class="BodyStyle">
        ...
        <section class="td-welcome">
            ...
            <div class="infos">
                <div class="logo-web-title">
                    <img class="logo-ws" src="https://files.catbox.moe/qkf4zb.gif" alt="Quangg Toàn">
    ...
    <main id="td-main">
        ...
        <section class="td-content">
            <div class="about-me">
                ...
                <div class="avatar">
                    <img class="avatar-img" src="<?=$ThanhDieuHeader->avatar?>?v=<?=rand(1,999)?>" alt="Quangg Toàn">
    ...
    <footer id="footer">
        <span>
            <a href="//thanhdieu.com" target="_blank">&copy; Copyright&nbsp;Quangg Toàn 2025</a>
        </span>
    </footer>
